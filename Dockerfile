...
WORKDIR /billd/nuxt3-blog-client

COPY package.json .
COPY pnpm-lock.yaml .
COPY .npmrc .

RUN cd /billd/nuxt3-blog-client
...
# 会退出容器
# CMD pm2 start './node_modules/nuxt/bin/nuxt.js' --name nuxt3-blog-client-null-3400  -i max -- start

# 单线程没问题，OK
# CMD pm2-runtime start './node_modules/nuxt/bin/nuxt.js' --name nuxt3-blog-client-null-3400 -- start

# 多线程报错，nuxt路径拼接错误：/Users/huangshuisheng/Desktop/hss/galaxy-s10/nuxt3-blog-client/node_modules/nuxt/bin/nuxt.js/.nuxt/dist/server.
# CMD pm2-runtime start './node_modules/nuxt/bin/nuxt.js' --name nuxt3-blog-client-null-3400 -i max -- start
