...
# FilePath: /nuxt3-blog-client/nuxt-pm2.sh
# Github: https://github.com/galaxy-s10
# LastEditors: shuisheng
# LastEditTime: 2023-10-14 19:34:20
###
...
echo 使用pm2维护:
# export PORT=3400 && pm2 start './.output/server/index.mjs' --name nuxt3-blog-client-null-3400 -i 1
export PORT=$PORT && pm2 start './.output/server/index.mjs' --name $JOBNAME-$ENV-$PORT -i 1

# pm2-runtime start './.output/server/index.mjs' --name nuxt3-blog-client-null-3400 -i 2 -- start
# pm2-runtime start './.output/server/index.mjs' --name $JOBNAME-$ENV-$PORT -i 2 -- start
